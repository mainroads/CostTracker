let
    ...
    #"Renamed Columns2" = Table.RenameColumns(#"Promoted Headers",{{"30000597-FMS_PA_Report07.xlsx", "FileName"}}),
    ...
    #"Added Vendor" = Table.AddColumn(#"Removed Columns1", "Vendor", each if [Vendor Name] <> null and Text.Trim([Vendor Name]) <> "" then
    [Vendor Name]
